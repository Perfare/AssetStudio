...
namespace Unity_Studio
{
    public partial class ExportOptions : Form
    {
        public ExportOptions()
        {
            ...
            exportSameNameMesh.Checked = (bool)Properties.Settings.Default["exportSameNameMesh"];
        ...
        private void fbxOKbutton_Click(object sender, EventArgs e)
        {
            ...
            Properties.Settings.Default["exportSameNameMesh"] = exportSameNameMesh.Checked;
            foreach (Control c in panel1.Controls)
            {
