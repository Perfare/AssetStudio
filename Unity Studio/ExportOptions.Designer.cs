namespace Unity_Studio
{
    partial class ExportOptions
    {
        ...
        private void InitializeComponent()
        {
			...
			this.extractBundle = new System.Windows.Forms.GroupBox();
			this.eBundleMultiple = new System.Windows.Forms.RadioButton();
			this.eBundleSingle = new System.Windows.Forms.RadioButton();
			...
			this.extractBundle.SuspendLayout();
			this.SuspendLayout();
			// 
			// includeBox
			// 
			...
			// extractBundle
			// 
			this.extractBundle.Controls.Add(this.eBundleMultiple);
			this.extractBundle.Controls.Add(this.eBundleSingle);
			this.extractBundle.Location = new System.Drawing.Point(267, 308);
			this.extractBundle.Name = "extractBundle";
			this.extractBundle.Size = new System.Drawing.Size(227, 82);
			this.extractBundle.TabIndex = 10;
			this.extractBundle.TabStop = false;
			this.extractBundle.Text = "Extract Bundle";
			// 
			// eBundleMultiple
			// 
			this.eBundleMultiple.AutoSize = true;
			this.eBundleMultiple.Location = new System.Drawing.Point(8, 44);
			this.eBundleMultiple.Name = "eBundleMultiple";
			this.eBundleMultiple.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.eBundleMultiple.Size = new System.Drawing.Size(191, 17);
			this.eBundleMultiple.TabIndex = 1;
			this.eBundleMultiple.Text = "Create a folder for each Bundle file.";
			this.eBundleMultiple.UseVisualStyleBackColor = true;
			this.eBundleMultiple.CheckedChanged += new System.EventHandler(this.eBundleMultiple_CheckedChanged);
			// 
			// eBundleSingle
			// 
			this.eBundleSingle.AutoSize = true;
			this.eBundleSingle.Checked = true;
			this.eBundleSingle.Location = new System.Drawing.Point(8, 21);
			this.eBundleSingle.Name = "eBundleSingle";
			this.eBundleSingle.Size = new System.Drawing.Size(190, 17);
			this.eBundleSingle.TabIndex = 0;
			this.eBundleSingle.TabStop = true;
			this.eBundleSingle.Text = "Create a single \"Unpacked\" folder.";
			this.eBundleSingle.UseVisualStyleBackColor = true;
			this.eBundleSingle.CheckedChanged += new System.EventHandler(this.eBundleSingle_CheckedChanged);
			// 
			// ExportOptions
			// 
			...
			this.Controls.Add(this.extractBundle);
			...
			this.extractBundle.ResumeLayout(false);
			this.extractBundle.PerformLayout();
		...
		private System.Windows.Forms.GroupBox extractBundle;
		private System.Windows.Forms.RadioButton eBundleMultiple;
		private System.Windows.Forms.RadioButton eBundleSingle;
	}
}